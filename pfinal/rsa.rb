...
ALFABETO_RSA = {"A"=>0,"B"=> 1,"C"=> 2,"D"=> 3,"E"=> 4,"F"=> 5,"G"=> 6,"H"=> 7,
"I"=> 8,"J"=> 9, "K"=>10, "L"=>11, "M"=>12, "N"=>13, "O"=>14, "P"=>15, "Q"=>16,
"R"=>17, "S"=>18, "T"=>19, "U"=>20, "V"=>21, "W"=>22, "X"=>23, "Y"=>24, "Z"=>25}

TAM_ALFABETO_RSA = ALFABETO_RSA.size() #tamaño del alfabeto
...
def euclides_extendido(num, mod)
  ...
  while(resto > 0)
    cociente = (dividendo / divisor).to_i
    resto = (dividendo % divisor).to_i

    if resto == 0 #para que no vuelva a calcular la z
      break
    end

    z = (((-1*cociente) * anterior) + ante_anterior).to_i
...
class Rsa
  ...
  def codificar(n)
    ...
    texto_bloques.each do |c|
      ...
      c.split("").each do |k|
        resultado_parcial = resultado_parcial + (ALFABETO_RSA[k]*(TAM_ALFABETO_RSA**i))
        i = i-1
      end
