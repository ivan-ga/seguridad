...
# #abriendo clase Integer para añadir método que cuenta dígitos
# class Integer
#
# 	  def num_digitos
#
...
class A5
  ...
  def calcular_mayoria(r1, r2, r3, imprimir)
  ...
  def cifrar(opcion)
    ...
    while iter<(n + tam_mensaje) do
      ...
      if iter >= n
        mayoria = calcular_mayoria(r1, r2, r3, true)
      else
        mayoria = calcular_mayoria(r1, r2, r3, false)
      end
